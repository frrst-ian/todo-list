...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/norwester-webfont.woff2 */ "./src/assets/fonts/norwester-webfont.woff2"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/norwester-webfont.woff */ "./src/assets/fonts/norwester-webfont.woff"), __webpack_require__.b);
...
`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;;;EAGE,sBAAsB;AACxB;;AAEA;EACE,SAAS;EACT,YAAY;AACd;;;AAGA;EACE,+BAA+B;EAC/B;6DACgE;EAChE,mBAAmB;EACnB,kBAAkB;;AAEpB;;AAEA;EACE,gBAAgB;EAChB,yBAAyB;EACzB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,+BAA+B;EAC/B,iBAAiB;EACjB,kBAAkB;EAClB,SAAS;EACT,WAAW;EACX,eAAe;EACf,cAAc;;;AAGhB;;AAEA;EACE,aAAa;EACb,gCAAgC;EAChC,yBAAyB;EACzB,iBAAiB;EACjB,aAAa;EACb,aAAa;AACf;;AAEA;EACE,yBAAyB;EACzB,aAAa;EACb,sBAAsB;EACtB,yBAAyB;EACzB,SAAS;EACT,mBAAmB;EACnB,mBAAmB;AACrB;;AAEA;;EAEE,YAAY;EACZ,eAAe;EACf,yBAAyB;EACzB,gBAAgB;EAChB,aAAa;EACb,YAAY;EACZ,mBAAmB;EACnB,YAAY;EACZ,eAAe;AACjB;;AAEA;EACE,cAAc;EACd,gBAAgB;AAClB;;AAEA;EACE,qBAAqB;EACrB,eAAe;EACf,kBAAkB;AACpB;AACA;EACE,YAAY;EACZ,mBAAmB;AACrB;AACA;;EAEE,yBAAyB;EACzB,mBAAmB;AACrB;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,QAAQ;EACR,yBAAyB;EACzB,iBAAiB;EACjB,mBAAmB;EACnB,aAAa;EACb,kBAAkB;EAClB,UAAU;EACV,YAAY;AACd;;AAEA;;EAEE,yBAAyB;AAC3B;AACA;;;;;;;;;;;EAWE,yBAAyB;EACzB,mBAAmB;EACnB,YAAY;EACZ,eAAe;EACf,aAAa;AACf;;AAEA;;;;;EAKE,yBAAyB;EACzB,eAAe;EACf,iBAAiB;EACjB,YAAY;EACZ,YAAY;EACZ,mBAAmB;EACnB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,SAAS;EACT,uBAAuB;AACzB;;AAEA;EACE,yBAAyB;EACzB,aAAa;EACb,iBAAiB;EACjB,mBAAmB;AACrB","sourcesContent":["*,\n*::before,\n*::after {\n  box-sizing: border-box;\n}\n\n* {\n  margin: 0;\n  color: white;\n}\n\n\n@font-face {\n  font-family: 'norwesterregular';\n  src: url('./assets/fonts/norwester-webfont.woff2') format('woff2'),\n       url('./assets/fonts/norwester-webfont.woff') format('woff');\n  font-weight: normal;\n  font-style: normal;\n\n}\n\nbody {\n  line-height: 1.5;\n  background-color: #1e293b;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  position: relative;\n}\n\n#logo {\n  font-family: 'norwesterregular';\n  text-align: start;\n  position: absolute;\n  top: 50px;\n  right:100px;\n  font-size: 2rem;\n  color: #f43f5e;\n\n\n}\n\ndiv#wrapper {\n  display: grid;\n  grid-template-columns: 1.5fr 3fr;\n  background-color: #1e293b;\n  margin-top: 150px;\n  width: 1000px;\n  height: 500px;\n}\n\ndiv#sidebar {\n  background-color: #334155;\n  display: flex;\n  flex-direction: column;\n  justify-content: baseline;\n  gap: 20px;\n  align-items: center;\n  border-radius: 16px;\n}\n\nbutton#add-task-btn,\nbutton#add-project-btn {\n  color: white;\n  font-size: 1rem;\n  background-color: #f43f5e;\n  margin-top: 40px;\n  padding: 10px;\n  border: none;\n  border-radius: 10px;\n  width: 116px;\n  cursor: pointer;\n}\n\n#title-project {\n  color: #e0e4e9;\n  font-weight: 550;\n}\n\n#project-list {\n  list-style-type: none;\n  cursor: pointer;\n  margin-right: 40px;\n}\nli {\n  padding: 5px;\n  border-radius: 12px;\n}\nli:hover,\nli.active {\n  background-color: #1e293b;\n  border-radius: 10px;\n}\nform {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  background-color: #334155;\n  border: 2px solid;\n  border-radius: 16px;\n  padding: 20px;\n  position: absolute;\n  top: 150px;\n  right: 620px;\n}\n\ninput[type=\"text\"],\ninput[type=\"date\"] {\n  border: 1px solid #334155;\n}\n#new-task-title,\n#new-task-description,\n#new-task-due-date,\n#new-task-priority,\n#new-task-notes,\n#new-project-name,\n#title,\n#description,\n#dueDate,\n#priority,\n#notes {\n  background-color: #64748b;\n  border-radius: 12px;\n  padding: 4px;\n  font-size: 1rem;\n  outline: none;\n}\n\n#add-button,\n#close-modal,\n#add-project-button,\nbutton[type=\" submit\"],\n#delete-todo {\n  background-color: #f43f5e;\n  margin-top: 4px;\n  font-size: 0.9rem;\n  padding: 8px;\n  border: none;\n  border-radius: 10px;\n  cursor: pointer;\n}\n\n.button-group {\n  display: flex;\n  gap: 10px;\n  justify-content: center;\n}\n\n#main {\n  background-color: #334155;\n  padding: 24px;\n  margin-left: 24px;\n  border-radius: 16px;\n}\n"],"sourceRoot":""}]);
// Exports
...
class TodoApp {
    ...
    createTodo(title, description, dueDate, priority, notes) {
        const todo = new _todo_js__WEBPACK_IMPORTED_MODULE_1__["default"](title, description, dueDate, priority, notes)
    ...
    loadFromLocalStorage() {
        ...
        if (data) {
            this.projects = JSON.parse(data).map(project => {
                const p = new _project_js__WEBPACK_IMPORTED_MODULE_0__["default"](project.name);
                p.todos = project.todos.map(todo => Object.assign(new _todo_js__WEBPACK_IMPORTED_MODULE_1__["default"](), todo));
                return p;
            })
        }
    }
    ...
    render() {
        ...
        this.currentProject.todos.forEach((todo, index) => {
            ...
            todoItem.textContent = `${todo.title} - Due: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(todo.dueDate), 'yyyy-MM-dd')}`;
    ...
    showTodoDetails(todoIndex) {
        ...
        createFormElement('Due Date:', 'date', 'dueDate', (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(todo.dueDate), 'yyyy-MM-dd'));
...
/***/ "./src/assets/fonts/norwester-webfont.woff":
/*!*************************************************!*\
  !*** ./src/assets/fonts/norwester-webfont.woff ***!
  \*************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "87e8eceace223f451817.woff";

/***/ }),

/***/ "./src/assets/fonts/norwester-webfont.woff2":
/*!**************************************************!*\
  !*** ./src/assets/fonts/norwester-webfont.woff2 ***!
  \**************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "9e0952540cac0bb9cb5c.woff2";
